	...
	<view>
		...
		<view class="content">
            ...
            *  -->
			...
			<view class="box">
				...
				<!-- 更多 -->
				<view class="fenlei">
					<image class="icon" src="https://novelsys.oss-cn-shenzhen.aliyuncs.com/ticket/static/image/componentImg/fenlei.png" @click="selectTypeShow" />
				</view>
			</view>

			<view class="content-wrapper" style="position: relative;">
				<view style="width: 750upx;height: 10upx;position: absolute;top: -10upx;z-index: 1000;background: #fff;"></view>
				<view class="hot" @click="maskShow(true)">
					{{ showText }}
					<image class="" src="https://novelsys.oss-cn-shenzhen.aliyuncs.com/ticket/static/image/componentImg/duobianxing.png" @click="maskShow(true)" />
				</view>
				<view class="hot" @click="openRiLi">
					{{ nowTime }}
					<image class="" src="https://novelsys.oss-cn-shenzhen.aliyuncs.com/ticket/static/image/componentImg/duobianxing.png" @click.stop="openRiLi" />
				</view>
				<!-- 选择分类弹框 -->
				<selectType :concerttypesData="concerttypesData" v-if="selectTypeOnoff" @selectTypeFn="selectTypeFn"></selectType>
		...
		<view class="mask" v-if="maskOnoff" @click="maskShow(false)">
			<view class="alter" @click.stop="">
				<view
					:class="index == check ? 'select-menu select-menu-active' : 'select-menu'"
					v-for="(item, index) in selectMenu"
					:key="index"
					@click.stop="changeCheck(index, item.title, item.name)"
				>
					{{ item.title }}
					<image v-if="index == check" class="" src="https://novelsys.oss-cn-shenzhen.aliyuncs.com/ticket/static/image/componentImg/gouxuan.png" />
					<image v-else class="" src="https://novelsys.oss-cn-shenzhen.aliyuncs.com/ticket/static/image/componentImg/tuoyuan.png" />
				</view>
			</view>
		</view>
		<!-- 日历 -->
		<view class="rili" v-show="riliOnoff">
			...
			<view class="btn-container">
				<view class="rest" @click="restFn">重置</view>
				<view class="ok" @click="closeAlert">确认</view>
			</view>
		</view>
